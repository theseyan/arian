...
const serverPackr = new Packr({structures: [["id", "m", "t", "d", "f"]], maxSharedStructures: 1});
const clientPackr = new Packr({structures: [["m", "e"]], maxSharedStructures: 1});
...
class Protocol {
    ...
    */
    static decode(buffer) {
        return serverPackr.unpack(buffer);
    }
    ...
    */
    static makeClientBody(event, message) {
        ...
        return clientPackr.pack(payload);
    }
    ...
    */
    static parseData(payload) {
        ...
        var data = clientPackr.unpack(new Uint8Array(payload));
