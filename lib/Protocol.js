...
// Record MessagePack structures for better performance
const serverPackr = new Packr({structures: []});
var {pack: serverPack, unpack: serverUnpack} = serverPackr;
const clientPackr = new Packr();
var {pack: clientPack, unpack: clientUnpack} = clientPackr;
