...
class NATSService {
    ...
    */
    request(type, body) {
        return new Promise((resolve, reject) => {
            ...
            // Publish Request
            this.nats.publish(this.server.CHANNEL_PREFIX + 'general', obj.buffer);
    ...
    */
    respond(id, type, body, to) {
        ...
        // Publish Response
        this.nats.publish(this.server.CHANNEL_PREFIX + 'respond-' + to, obj);
    }
    ...
    */
    sendMessage(room, event, message) {
        ...
        this.nats.publish(this.server.CHANNEL_PREFIX + 'room-' + room, buffer);
    }
